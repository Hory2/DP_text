...
Měrné hodnoty jsou nejdřív transformovány do $dq$ souřadnic. Regulátor na jejich základě a generuje vektor požadovaného napětí $V_{\alpha \beta_{13}}^*$ v $\alpha \beta$ souřadnicích. Modulátor následně generuje sekvenci přepnutí, kterou přímo ovládá střídač.
