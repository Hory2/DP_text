...
Strategie pro určení referenčních proudů v této oblasti  $\omega >\omega_{base }$ je podbná MTPA jenom v tété situaci je hlavním cíle maximálně využít dostupné npětí \ref{eq:MTPV napeti}, Otattní podmimky pro limit proudů  \ref{eq:podm sw}, \ref{eq:isw max} výpočt  momnetu zustaváníji beze změny.
...
\end{equation}
Pokud tedy otáčky motoru přesánhou wbse učenou jako kladný kořen rovnice\ref{eq:omega base}  \cite{fieldVeak} přenu se  genrováni refernenčních proud  z MTPA startegie na MTPV
...
V \cite{fieldVeak} je odvozeno že optimální proud id1 vycházející z výše zníněných přepokladů odopovídá lze zikat offsetem požadoavného proudu určeného MTPA o % i_{ds1}$ daný rovnicí \ref{eq:ids1 MTPV}.
...
Konstanta $k_3$ snanovuje poměr 1. a 3. harmonické. Konsatbu volim stejně jako v \cite{fieldVeak}, $k_3 = 0{,}15$. Tatometoda je výzamně závislnná na přesných paramerech motoru.
