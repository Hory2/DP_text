...
uhel naotcnin motru je pak  odpovídá integarci optáček motoru.
...
Cílem této kapitoly je  aplikovat představenou transformaci na model motoru, ten nejdříve převedu do $\alpha \beta_{1,3}$ a následně $dq_{1,3}$. Získat tak model motoru v $dq_{1,3}$.
