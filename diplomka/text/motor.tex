%bez editace
\section{Motor}
Práce se zabývá řízením pěticifázového synchronního motoru s permanentními magnety, konkrétně IPMSM (Interior Permanent Magnet Synchronous Machine), tedy motoru s magnety umístěnými uvnitř rotoru. Konkrétní parametry jsou shrnuty v tabulce~\ref{tab:param_motoru}.

Nejjednodušší konfigurace pěticifázového PMSM má rotor tvořený permanentním magnetem. Na statoru je rovnoměrně rozmístěno 5 statorových vinutí po $72^\circ$. Jednotlivé fáze jsou označeny a, b, c, d, e. Konce vinutí jsou spojeny do hvězdy.
